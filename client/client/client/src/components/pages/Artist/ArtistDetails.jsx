...
const ArtistDetails = ({ artist, adminAuthenticated, userAuthenticated, openEditModal }) => {
    ...
    return (
        <div className='w-1/3 p-4 border-r text-center text-white'>
            <ArtistImage image={`http://localhost:3000/${artist.image}`} alt={artist.artist_name} adminAuthenticated={adminAuthenticated} userAuthenticated={userAuthenticated} openEditModal={openEditModal} />
            <div className='px-4'>
